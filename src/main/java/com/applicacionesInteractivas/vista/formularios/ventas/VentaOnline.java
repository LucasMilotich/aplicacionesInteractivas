...
public class VentaOnline extends JFrame {
	...
	private JButton btnDatosTarjeta;
	...
	public VentaOnline() {
		...
		lblDatosTarjeta = new JLabel("Forma de Pago");
		lblDatosTarjeta.setBounds(20, 230, 120, 28);
		getContentPane().add(lblDatosTarjeta);
		
		btnDatosTarjeta = new JButton("Datos Tarjeta");
		btnDatosTarjeta.addActionListener(e -> {
			if(datosTarjeta == null)
				datosTarjeta = new FormTarjeta();
			datosTarjeta.setVisible(true);
		});
		btnDatosTarjeta.setBounds(130, 230, 160, 28);
		getContentPane().add(btnDatosTarjeta);
