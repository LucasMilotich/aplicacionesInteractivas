...
public class FormAltaDescuento extends JFrame {
    ...
    public FormAltaDescuento() {
        ...
        lblTipoDescuento.setToolTipText("Para descuentos del tipo 2x1, tipear (cantidad de productos a comprar)x(cantidad productos a pagar). Para descuentos porcentuales, tipear el numero con el signo porcentaje al lado");
        txtTipoDescuento.setToolTipText("Para descuentos del tipo 2x1, tipear (cantidad de productos a comprar)x(cantidad productos a pagar). Para descuentos porcentuales, tipear el numero con el signo porcentaje al lado");
        ...
        btnConfirm.addActionListener(e -> {
            ...
            if (txtNombreDescuento.getText().equals("") || txtVigenciaDesde.getText().equals("") || txtVigenciaHasta.getText().equals("") || txtTipoDescuento.getText().equals("")) {
